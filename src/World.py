...
class World():
    ...
    def run ( self ):
        ...
        while self.__score >= -1000:
            if self.__debug or self.__manualAI or self.file:
                self.__printWorldInfo()
                
                if not self.__manualAI and not self.file:
    ...
    def __printTileInfo ( self, c, r ):
        ...
        tileString += "."
        self.file.write(tileString.rjust(8))
    ...
    def __printAgentInfo ( self ):
        ...
        self.file.write("Score: "   + str(self.__score) + "\n")
        self.file.write("AgentX: "  + str(self.__agentX) + "\n")
        self.file.write("AgentY: "  + str(self.__agentY) + "\n")
    ...
    def __printDirectionInfo ( self ):
        if self.__agentDir == 0:
            ...
            self.file.write("AgentDir: Right" + "\n")
        elif self.__agentDir == 1:
            print ( "AgentDir: Down" )
            self.file.write("AgentDir: Down" + "\n")
        elif self.__agentDir == 2:
            print ( "AgentDir: Left" )
            self.file.write("AgentDir: Left" + "\n")
        elif self.__agentDir == 3:
            print ( "AgentDir: Up" )
            self.file.write("AgentDir: Up" + "\n")
        else:
            print ( "AgentDir: Invalid" )
            self.file.write("AgentDir: Invalid" + "\n")

    
    def __printActionInfo ( self ):
        if self.__lastAction == Agent.Action.TURN_LEFT:
            print ( "Last Action: Turned Left" )
            self.file.write("Last Action: Turned Left" + "\n")


        elif self.__lastAction == Agent.Action.TURN_RIGHT:
            print ( "Last Action: Turned Right")
            self.file.write("Last Action: Turned Right" + "\n")


        elif self.__lastAction == Agent.Action.FORWARD:
            print ( "Last Action: Moved Forward")
            self.file.write("Last Action: Moved Forward" + "\n")


        elif self.__lastAction == Agent.Action.SHOOT:
            print ( "Last Action: Shot the Arrow")
            self.file.write("Last Action: Shot the Arrow" + "\n")


        elif self.__lastAction == Agent.Action.GRAB:
            print ( "Last Action: Grabbed")
            self.file.write("Last Action: Grabbed" + "\n")


        elif self.__lastAction == Agent.Action.CLIMB:
            print ( "Last Action: Climbed")
            self.file.write("Last Action: Climbed" + "\n")


        else:
            print ( "Last Action: Invalid")
            self.file.write("Last Action: Invalid" + "\n")
